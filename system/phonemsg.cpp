...
#define MSG_SURE_D	     26288 //??(按下)(黄色的)
#define MSG_SURE_U	     26289 //??(弹起)(黄色的)
#define MSG_CANCEL_U	 26284 //??(未按下)
#define MSG_CANCEL_D	 26285 //??(按下)
...
DWORD WINAPI MsgThread(LPVOID param)
{
	...
	switch(myvalue)
	{
				...
				case 7:
					...
					StockChatBufferLine("无法??本则简讯是否成功?!",FONT_PAL_WHITE);
					break;
				case -1:
