...
#endif
#define LSSPROTO_BATTLEBUTTON_RECV 150
...
#ifdef _NB_获取机器信息包
#define LSSPROTO_GETINFO_RECV	209
#define LSSPROTO_GETINFO_SEND	210
void lssproto_GetInfo_send(int fd);
#endif

#define LSSPROTO_查询光环_SEND 212  //发送查询光环、称号、皮肤信息
#define LSSPROTO_查询光环_RECV 213
#define LSSPROTO_CHAREFFECT_RECV 214

#ifdef _NB_管理模式
#define LSSPROTO_GMSET_SEND	301
void lssproto_Gmset_send(int fd,int index,char* data);
#endif

#ifdef _ON_OFF_ITEM
#define LSSPROTO_EXPUP_SEND 400
void lssproto_Expup_send(int fd);
#endif

#ifdef _ON_OFF_NOENEMY
#define LSSPROTO_NOENEMY_SEND 401
void lssproto_Noenemy_send(int fd);
#endif

#ifdef _CLICK_PARTYAUTO
#define LSSPROTO_PARTYAUTO_SEND 402
void lssproto_Partyauto_send(int fd);
#endif

#ifdef _CHAR_INFOSTORAGE
#define LSSPROTO_PETSHOPCALL_SEND 450
#define LSSPROTO_POOLITEMCALL_SEND 451
void lssproto_petshopcall_send(int fd);
void lssproto_poolitemcall_send(int fd);
#endif

#define LSSPROTO_MAMMOTH_SEND		500
#define LSSPROTO_MAMMOTH_RECV		501
#define LSSPROTO_MAMMOTH_OPEN_RECV	502



#define LSSPROTO_PETRANK_SEND		503
#define LSSPROTO_PETRANK_RECV		504
